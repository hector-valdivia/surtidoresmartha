...
<head>
	...
	<title>Cliente <?php echo $id_cliente; ?></title>
...
<div id="wrap" class="container_24">
	...
	<div class="grid_24">
		<div class="box_top">
			<h2 class="icon frames">Editar informacion de <i><?php echo $r->cliente; ?></i></h2>			
		</div>
		...
		<div class="box_content padding">
			<form action="enviar.php" name="agregar_usuario" id="agregar_usuario" class="validar" method="post" enctype="multipart/form-data">				
				<div class="field">
					...
					<input type="text" name="email" id="email" class="validate[required,custom[email]]" placeholder="correo@dominio.com" value="<?php echo $r->email; ?>" />
				</div>							

				<div class="field">
					<label class="left">Telefono</label>
					<input type="text" name="tel" id="tel" class="big validate[groupRequired[tel],custom[phone]]" placeholder="XXX-XX-XX" value="<?php echo $r->telefono; ?>" />
				</div>

				<div class="field">
					<label class="left">Celular</label>
					<input type="text" name="cel" id="cel" class="big validate[groupRequired[tel],custom[phone]]" placeholder="044-614-XXX-XX-XX" value="<?php echo $r->celular; ?>" />
				</div>
				...
				<div class="field">
					<input type="text" name="empresa" id="empresa" value="<?php echo $r->cliente; ?>" readonly="true" class="small validate[required] text-input" style="display:none;" />
