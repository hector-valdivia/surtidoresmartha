...
<div id="wrap" class="container_24">
	...
	<!-- Menu: End -->
	<form action="enviar" name="menu" id="menu" method="post" class="validar" enctype="multipart/form-data" accept-charset="UTF-8">
	<div class="row">
		<div class="col-lg-12">
			...
			<div class="box_content padding">
		    	...
		    	<div id="cliente-registrado" style="display:none;" >
					...
					<div class="form-group">
						...
						<input type="text" name="fecha_deseada" id="fecha_deseada1" class="form-control validate[required,custom[date]] date datepicker" autocomplete="off" />
					</div>
				</div>
			</div>
		</div>
